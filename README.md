...
Legato Open Source Project is an initiative by Sierra Wireless Inc. which provides an open, secure and easy to use Application Framework for embedded devices. The project enables developers who are not experienced in traditional embedded programming to participate in the exponential growth of "Internet of Things". Visit [legato.io](http://legato.io) to learn more or visit the [Legato forum](http://forum.legato.io).
