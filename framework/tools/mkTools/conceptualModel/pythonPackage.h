...
#ifndef LEGATO_MKTOOLS_MODEL_PYTHON_PACKAGE_H_INCLUDE_GUARD
#define LEGATO_MKTOOLS_MODEL_PYTHON_PACKAGE_H_INCLUDE_GUARD
...
#endif // LEGATO_MKTOOLS_MODEL_PYTHON_PACKAGE_H_INCLUDE_GUARD
