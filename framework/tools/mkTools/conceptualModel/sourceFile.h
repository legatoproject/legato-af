...
#ifndef LEGATO_MKTOOLS_MODEL_SOURCE_FILE_H_INCLUDE_GUARD
#define LEGATO_MKTOOLS_MODEL_SOURCE_FILE_H_INCLUDE_GUARD
...
#endif // LEGATO_MKTOOLS_MODEL_SOURCE_FILE_H_INCLUDE_GUARD
