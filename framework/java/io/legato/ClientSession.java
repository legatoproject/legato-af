...
//--------------------------------------------------------------------------------------------------
/**
 *  Used by service clients, the client session holds the functionality needed to connect and
 *  disconnect from Legato services.
 */
//--------------------------------------------------------------------------------------------------
public class ClientSession extends Session implements AutoCloseable
{
    //----------------------------------------------------------------------------------------------
    /**
     *  Construct a new session from a native reference.  This method is private to the package and
     *  is only intended to be used by other classes within this package.
     *
     ...
     *
     *  @param protocol     The protocol to use in this session.
     ...
     *
     *  @param handler  The handler object that will be called when the event is received.
     */
    //----------------------------------------------------------------------------------------------
