 ...
 *
 * @section utf8_monotonic Monotonic Strings
 *
 * Occasionally, when creating identifiers for a set of objects it is useful to be able to generate
 * a set of mutually unique strings.  The identifiers may not have any meanings themselves but what
 * is important is that they uniquely identify the object.  The license plate number of cars is a
 * good example of this.
 *
 * The function le_utf8_GetMonotonicString() in this module can be used to generate a series of
 * mutually exclusive strings.  The strings generated by this function differ from our license plate
 * example in that the generated strings are variable length and are ordered.  Nevertheless, the
 * important property of these strings are that they are mutually unique and can be used as
 * identifiers for a set of objects.
 *
 * Passing an empty string to the le_utf8_GetMonotonicString() function will generate the first
 * string in the series.  Passing the first string back into le_utf8_GetMonotonicString() will
 * generate the next string in the series.  Continuing to pass the previously generated string to
 * le_utf8_GetMonotonicString() will produce a series of unique strings.
 *
