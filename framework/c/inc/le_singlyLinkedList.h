 ...
 *
 * All linked list function calls are re-entrant and thread safe.  But if the nodes and/or list
 * object is shared by multiple threads, then explicit steps must be taken to maintain mutual
 * exclusion of access.
 *
 * <HR>
 *
