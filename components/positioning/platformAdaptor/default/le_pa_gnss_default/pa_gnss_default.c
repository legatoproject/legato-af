 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t __attribute__((weak)) pa_gnss_DownloadExtendedEphemeris
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t __attribute__((weak)) pa_gnss_SetStaticFilter
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t __attribute__((weak)) pa_gnss_GetStaticFilter
(
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t __attribute__((weak)) pa_gnss_DisableExternalLna
(
    void
)
{
 ...
 */
//--------------------------------------------------------------------------------------------------
le_result_t __attribute__((weak)) pa_gnss_GetExternalLna
(
