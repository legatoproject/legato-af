...
)
{
    ...
    le_mdc_StartClient("le_mdc");

    // Register for data session state changes
    // Hard coded with the first profile
...
)
{
    ...
    le_posCtrl_StartClient("le_posCtrl");
