...
// #else
// static char*    PIN_TEST[]={PIN_TEST1, PIN_TEST2};
// static char*    PUK_TEST[]={PUK_TEST1, PUK_TEST2};
// #endif
 ...
 */
//--------------------------------------------------------------------------------------------------
static void TestSimStateHandler(le_sim_Ref_t simRef, void* contextPtr)
{
...
void TestInteractivele_sim_Authentication()
{
    ...
    do
    {
        ...
        res = pa_sim_GetState(&state);
        fprintf(stderr, "\nSIM Card state, res.%d  (should be LE_OK=0), press enter\n", res);
...
void Testle_sim_States()
{
    ...
    do
    {
        ...
        fprintf(stderr, "\nSIM Card.%d state, res.%d  (should be LE_OK=0)\n", i, res);
        displaySIMState(state, i);
        // Enter PIN
...
//     le_sim_RemoveNewStateHandler(testHdlrRef);
}
