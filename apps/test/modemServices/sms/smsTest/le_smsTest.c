...
void Testle_sms_SetGetText()
{
    ...
    res=le_sms_SetText(myMsg, FAIL_TEXT_TEST_PATTERN);
...
void Testle_sms_SetGetBinary()
{
    ...
    res=le_sms_SetBinary(myMsg, BINARY_TEST_PATTERN, sizeof(FAIL_BINARY_TEST_PATTERN));
    CU_ASSERT_EQUAL(res, LE_OUT_OF_RANGE);
...
void Testle_sms_SetGetPDU()
{
    ...
    res=le_sms_SetPDU(myMsg, PDU_TEST_PATTERN_7BITS, LE_SMS_PDU_MAX_LEN*2);
    CU_ASSERT_EQUAL(res, LE_OUT_OF_RANGE);
