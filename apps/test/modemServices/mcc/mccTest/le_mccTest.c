...
//--------------------------------------------------------------------------------------------------
/**
 * Handler function for Call Event Notifications associated to the profile.
 *
 */
//--------------------------------------------------------------------------------------------------
 ...
 * Execute app : execInApp mccTest mccTest <Destination phone number> <CLIR_ON | CLIR_OFF>
